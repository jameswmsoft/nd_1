									...
									<div class="panel-collapse collapse in sms_texts_section" style="display:none" aria-expanded="true">
										<div class="portlet-body" style="padding:10px;">
                                            ...
                                            <div class="form-group">
												...
												<span class="showCounter">
													<span class="showCount"><?php echo (@$maxLength-strlen(DBout(@$row['correct_sms'])))?></span> Characters left
												</span>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<span class="showCounter">
													<span class="showCount"><?php echo (@$maxLength-strlen(DBout(@$row['wrong_sms'])))?></span> Characters left
												</span>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<span class="showCounter">
													<span class="showCount"><?php echo (@$maxLength-strlen(DBout(@$row['complete_sms'])))?></span> Characters left
												</span>
											</div>
                            ...
                            <div class="col-lg-12" style="padding:0px !important;">
								<div class="portlet">
									<div class="portlet-heading bg-custom" style="background-color:#9350e9 !important; padding:2px 5px 2px 10px !important; border-radius:5px;">
										<h5 style="color:#FFF !important">
											Questions/Answers
											<a onclick="slideToggleMainSection(this,'question_answer_section','');" href="javascript:;"><i class="fa fa-plus" title="Open" style="color:#FFF !important; float:right !important"></i></a>
										</h5>
										<div class="portlet-widgets">
											<span class="divider"></span>
											<a href="#bg-primary" data-parent="#accordion1" data-toggle="collapse" class="" aria-expanded="true"><i class="ion-minus-round" title="Show/Hide" style="color:#FFF !important"></i></a>
									...
									<div class="panel-collapse collapse in question_answer_section" style="display:" aria-expanded="true">
										<div class="portlet-body" style="padding:10px;">
                                            ...
                                            $no_of_questions = 0;
                                            if(@$_REQUEST['id']!=''){
                                        		$sql_q = "select * from trivia_questions where campaign_id='".$_REQUEST['id']."'";
                                        		$res_q = mysqli_query($link,$sql_q);
                                        		$no_of_questions = mysqli_num_rows($res_q);	
                                        	}
                                            ?>
                                            
                                            
                                            
                                            <input id="no_of_questions" value="<?php if($no_of_questions>0){ echo $no_of_questions; }else{ echo "1"; } ?>" type="hidden" />
                                            ...
                                            <div id="questions">
                                                ...
                                                if($no_of_questions > 0){
                                        			...
                                        			while($row_q = mysqli_fetch_assoc($res_q)){
                                                         ...
                                                         ?>
                                                         <div id="question_<?php echo $q;?>">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                    								<label>Question*</label>
                                    								<textarea id="question_<?php echo $q;?>" name="field[<?php echo $q;?>][question]" placeholder="Enter welcome question sms text..." class="form-control textCounter"><?php echo $row_q['question']; ?></textarea>
                                    								<span class="showCounter">
                                                            ...
                                                            $sql_a = "select * from trivia_answers where question_id='".$row_q['id']."'";
                                                    		$res_a = mysqli_query($link,$sql_a);
                                                    		$no_of_answers = mysqli_num_rows($res_a);	
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <input id="no_of_ans_<?php echo $q;?>" value="<?php if($no_of_answers>0){ echo $no_of_answers; }else{ echo "1"; } ?>" type="hidden" />
                                                            </div>
                                                            <div id="answers_<?php echo $q;?>">
                                                                <?php
                                                                if($no_of_answers > 0){
                                                                $a=1;
                                                                    ...
                                                                    ?>
                                                                    <div class="">
                                                                        <div class="col-md-5"> <input name="field[<?php echo $q;?>][answers][<?php echo $a;?>][answer]" id="answer_<?php echo $q;?>_<?php echo $a;?>" value="<?php echo $row_a['answer']; ?>" class="form-control" /> </div>
                                                                        <div class="col-md-2"> <input name="field[<?php echo $q;?>][answers][<?php echo $a;?>][value]" id="value_<?php echo $q;?>_<?php echo $a;?>"  value="<?php echo $row_a['value']; ?>"class="form-control" /> </div>
                                                                        <div class="col-md-3"> <input name="field[<?php echo $q;?>][answers][<?php echo $a;?>][correct]" id="correct_<?php echo $q;?>_<?php echo $a;?>" <?php if($row_a['correct']==1){ echo "checked"; } ?> class="form-control" value="1" type="checkbox" /> </div>
                                                                        ...
                                                                        if($a!="1"){?>
                                                                            ...
                                                                            ?>  
                                                                            <button type="button" class="btn btn-success" onclick="addAnswer('<?php echo $q;?>')" ><i class="fa fa-plus"></i></button>
                                                                        </div>
                                                                    </div>
                                                                    <?php
                                                                        $a++;
...
?>
            ...
            <div id="answer_structure" style="display: none;">
                <div class="">
            ...
            <div id="question_structure" style="display: none;">
