									...
									<div class="panel-collapse collapse in sms_texts_section" style="display:" aria-expanded="true">
										<div class="portlet-body" style="padding:10px;">
                                            ...
                                            <div class="form-group">
												...
												<textarea name="winner_msg" parsley-trigger="change" required placeholder="Enter winner message" class="form-control textCounter"><?php echo DBout(@$row['winner_msg'])?></textarea>
                                            ...
                                            <div class="form-group">
												...
												<textarea name="looser_msg" parsley-trigger="change" required placeholder="Enter looser message" class="form-control textCounter"><?php echo DBout(@$row['looser_msg'])?></textarea>
												<span class="showCounter">
													<span class="showCount"><?php echo (@$maxLength-strlen(DBout(@$row['looser_msg'])))?></span> Characters left
												</span>
											</div>
