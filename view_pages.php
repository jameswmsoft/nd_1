		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<h4 class="title">Coupon Pages
								<input type="button" class="btn btn-primary" value="Add New" style="float:right !important" onclick="window.location='create_pages.php'" />
							</h4>
							<p class="category">Your already saved list of pages.</p>
						...
						<div class="content table-responsive table-full-width">
							<table id="campaignTable" class="table table-hover table-striped listTable">
								...
								<tbody>
									<?php
										$sql = "select * from pages where created_user='".$_SESSION['user_id']."' order by id desc";
										if(is_numeric(@$_GET['page']))
											$pageNum = $_GET['page'];
										else
											$pageNum = 1;
										$max_records_per_page = 20;
										$pagelink 	= "view_pages.php?";
									...
									?>
												<tr>
													...
													<td align="center"><?php echo $row['short_url'];?></td>
													<td style="text-align:center">
														<a target="_blank" href="view_page.php?id=<?php echo $row['id']?>" title="Visit page"><i class="fa fa-link"></i></a>
                                                        <a href="create_pages.php?id=<?php echo $row['id']?>" title="Edit page"><i class="fa fa-edit"></i></a>
														<i class="fa fa-remove" style="color:red; cursor:pointer" title="Delete page" onclick="deletePage('<?php echo $row['id']?>')"></i>
													</td>
												</tr>
									<?php			
											}	
...
<script>
	...
	function deletePage(id,img){
		if(confirm("Are you sure you want to delete this page?")){
			window.location = 'server.php?cmd=delete_page&id='+id;
		}
	}
</script>