		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						<div class="header">
							<h4 class="title">Trivia Campagins
								<input type="button" class="btn btn-primary" value="Add New" style="float:right !important" onclick="window.location='add_trivia.php'" />
							</h4>
						...
						<div class="content table-responsive table-full-width">
							<table id="campaignTable" class="table table-hover table-striped listTable">
								...
								<tbody>
									<?php
										$sql = "select * from campaigns where user_id='".$_SESSION['user_id']."' and type='3' order by id desc";
										if(is_numeric(@$_GET['page']))
											$pageNum = $_GET['page'];
										else
											$pageNum = 1;
										$max_records_per_page = 20;
										$pagelink 	= "trivias.php?";
									...
									?>
												<tr>
													...
													<td style="text-align:center">
														...
														<a href="add_trivia.php?id=<?php echo $row['id']?>" title="Edit campaign"><i class="fa fa-edit"></i></a>
